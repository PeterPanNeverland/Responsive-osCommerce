...
define('SUBHEADING_TITLE_2', 'Change/remove fields');
...
you want to have a field that will be used for all products, write "all" and nothing else. If you have subcategories, you can also put parent categories id here, the field will show up in all subcategories as well.');

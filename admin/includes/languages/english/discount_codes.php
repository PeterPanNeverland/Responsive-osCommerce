...
define('TEXT_DISCOUNT_EXPL', '<small>You can enter a fixed or percentage discount amount, for example: <strong>5</strong> or <strong>10%</strong><br>Shipping discounts can only be set as percentage. Type <strong>100%</strong> for free shipping.</small>');
